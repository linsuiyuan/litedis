...
class TestBasicKeyCommand:
    ...
    def test_set_with_exat(self, command):
        ...
        command.execute_command.assert_called_once_with("set", "test_key", "test_value", "exat", 1234567890)
    ...
    def test_set_with_pxat(self, command):
        ...
        command.execute_command.assert_called_once_with("set", "test_key", "test_value", "pxat", 1234567890000)
    ...
    def test_set_with_multiple_options(self, command):
        ...
        command.execute_command.assert_called_once_with(
